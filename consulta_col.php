...
<head>
    ...
    <title>Consulta Colegio</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <h1>Consulta Colegio</h1>
        ...
        if(isset($_SESSION['username']))
        {
            ...
            while($fila = mysqli_fetch_array($resultado))
            {
                echo "<tr>";
                    ...
                    echo "</td>";
                    echo "<td>";
                    echo $fila['nombre_colegio'];
                    echo "</td>";
                    echo "<td>";
                    echo $fila['municipio_colegio'];
                    echo "</td>";
                    echo "<td>";
                    echo $fila['correo_colegio'];
                    echo "</td>";
                    echo "<td>";
                    echo $fila['telefono_colegio'];
                    echo "</td>";
                    echo "<td>";
                    echo $fila['rector_colegio'];
                    echo "</td>";
                echo "</tr>";
            }
